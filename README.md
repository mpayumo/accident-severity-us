...
The map below will also be developed further with added computing power. Click [here](img/map.html) to check which streets in San Francisco where traffic accidents took place.
